...
- (void)setupConstraints {
    ...
    [self.alertBackgroundView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:[NSString stringWithFormat:@"H:|-(%f)-[_actionButtonContainerView]-(%f)-|", self.buttonHorizontalMargin, self.buttonHorizontalMargin]
                                                                                     options:0
                                                                                     metrics:nil
...
- (void)setButtonHorizontalMargin:(CGFloat)buttonHorizontalMargin {
    _buttonHorizontalMargin = buttonHorizontalMargin;
    [self setupConstraints];
}
